# Question1_2.py 2
'''
Generate European option payoff surfaces
'''

from EuropeanOptionPayoff import *
import numpy as np
...
european_call_payoff = European_Call_Option_Payoff( stock_price, strike_price )
european_put_payoff = European_Put_Option_Payoff( stock_price, strike_price )
